...
<body class="">
    ...
    <div class="audio">
        <audio id="playAudio" webkit-playsinline="true" playsinline="true" src="<?= base_url('assets/') ?>audio/new/in.wav"></audio>
    </div>
    ...
    <script type="text/javascript">
        ...
        $("document").ready(function() {
            $.post(base_url + "home/getData", function(data) {
